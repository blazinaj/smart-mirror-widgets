...
class CameraWidget extends Component {
    render() {
        ...
        // @ts-ignore
        return createElement(Webcam, { audio: coreAPI.audio, height: coreAPI.height, ref: coreAPI.webcamRef, screenshotFormat: "image/jpeg", width: coreAPI.width, videoConstraints: coreAPI.videoConstraints });
    }
}
